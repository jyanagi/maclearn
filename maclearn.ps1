...
Connect-VIServer -Server your.vcsa.address

Set-MacLearn -DVPortgroupName @("DVS-Trunk") -EnableMacLearn $true -EnablePromiscuous $false -EnableForgedTransmit $false -EnableMacChange $false -AllowUnicastFlooding $true

Get-MacLearn -DVPortgroupName @("DVS-Trunk")
